    ...
    return(
      <div className = "salesCard">
        <Card>
          ...
          <CardText>
          <form>
            <TextField hintText="Item Cost" id="itemCost" value={this.state.totalTax} onChange={this.calculateTax}/>
            <br />
            <TextField hintText="Sales Tax Percentage (%)" id="taxPercentage" value={this.state.costOfItem} onChange={this.calculateTax}/>
            <br />
            <br />
